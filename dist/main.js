...
var $author$project$Page$About$init = function (_v0) {
	return _Utils_Tuple2(
		{},
		$author$project$Page$About$renderGithubCards(_Utils_Tuple0));
};
...
var $gicentre$elm_vegalite$VegaLite$colorGradientSpec = function (gr) {
	if (gr.$ === 'GrLinear') {
			...
			return _Utils_Tuple2(
				...
				$elm$json$Json$Encode$object(
					A2(
						...
						_Utils_Tuple2(
							'gradient',
							$gicentre$elm_vegalite$VegaLite$colorGradientSpec(cGrad)),
...
var $author$project$Demo$LogisticRegression$emptyModel = {demoId: '', demoModel: $author$project$Demo$LogisticRegression$emptyLogisticRegressionModel, demoSpecs: $author$project$Demo$LogisticRegression$emptySpec, serverError: $elm$core$Maybe$Nothing};
...
var $author$project$Main$stepTutorial = F2(
	function (model, _v0) {
		var tutorial = _v0.a;
		var cmds = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$Tutorial(tutorial)
				}),
...
var $author$project$Main$tutorialName_ = A2($elm$url$Url$Parser$custom, 'TUTORIAL', $elm$core$Maybe$Just);
	...
	function (sharedState, msg, model) {
		switch (msg.$) {
			...
			case 'ChangedUserPassword':
				...
				return A2($author$project$Page$Home$changedUserPassword, newPassword, model);
			default:
				return $author$project$Page$Home$closePopUp(model);
		}
	});
...
var $gicentre$elm_vegalite$VegaLite$filterProperty = function (f) {
	switch (f.$) {
		case 'FEqual':
			var field = f.a;
			var val = f.b;
...
var $gicentre$elm_vegalite$VegaLite$titleSpec = function (tText) {
	...
	switch (legendProp.$) {
		...
		case 'LTitle':
			...
			return (s === '') ? _Utils_Tuple2('title', $elm$json$Json$Encode$null) : _Utils_Tuple2(
				'title',
				$gicentre$elm_vegalite$VegaLite$titleSpec(s));
		case 'LTitleAlign':
			var ha = legendProp.a;
			return _Utils_Tuple2(
				'titleAlign',
		...
		case 'MTitle':
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'title',
					$gicentre$elm_vegalite$VegaLite$titleSpec(t))
				]);
		case 'MAggregate':
			var op = field.a;
			return _List_fromArray(
	...
	function (mc, f) {
		switch (f.$) {
			...
			default:
				return $elm$json$Json$Encode$object(
					_Utils_ap(
						$gicentre$elm_vegalite$VegaLite$markChannelProperty(mc),
						$gicentre$elm_vegalite$VegaLite$filterProperty(f)));
		}
	});
	...
	function (pos, pDefs) {
		...
		switch (pos.$) {
			...
			case 'XError':
				return $elm$core$List$cons(
					_Utils_Tuple2(
						$gicentre$elm_vegalite$VegaLite$positionLabel($gicentre$elm_vegalite$VegaLite$XError),
						$elm$json$Json$Encode$object(
							A2($elm$core$List$map, $gicentre$elm_vegalite$VegaLite$positionChannelProperty, pDefs))));
			case 'YError':
				return $elm$core$List$cons(
					_Utils_Tuple2(
						$gicentre$elm_vegalite$VegaLite$positionLabel($gicentre$elm_vegalite$VegaLite$YError),
						$elm$json$Json$Encode$object(
							A2($elm$core$List$map, $gicentre$elm_vegalite$VegaLite$positionChannelProperty, pDefs))));
			case 'XError2':
				return $elm$core$List$cons(
					_Utils_Tuple2(
						$gicentre$elm_vegalite$VegaLite$positionLabel($gicentre$elm_vegalite$VegaLite$XError2),
						$elm$json$Json$Encode$object(
							A2($elm$core$List$map, $gicentre$elm_vegalite$VegaLite$positionChannelProperty, pDefs))));
			case 'YError2':
				return $elm$core$List$cons(
					_Utils_Tuple2(
						$gicentre$elm_vegalite$VegaLite$positionLabel($gicentre$elm_vegalite$VegaLite$YError2),
						$elm$json$Json$Encode$object(
							A2($elm$core$List$map, $gicentre$elm_vegalite$VegaLite$positionChannelProperty, pDefs))));
			case 'Longitude':
				return $elm$core$List$cons(
				...
				A2(
					...
					$gicentre$elm_vegalite$VegaLite$nums(
						A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($elm_community$list_extra$List$Extra$getAt, 0, model.demoModel.x))))),
			A2(
				$gicentre$elm_vegalite$VegaLite$dataColumn,
				'y',
				$gicentre$elm_vegalite$VegaLite$nums(
					A2(
						$elm$core$Maybe$withDefault,
						_List_Nil,
						A2($elm_community$list_extra$List$Extra$getAt, 1, model.demoModel.x))))),
		A2(
			$gicentre$elm_vegalite$VegaLite$dataColumn,
			'group',
...
var $author$project$Demo$LogisticRegression$LogisticRegressionModel = F4(
	function (x, y, w, loss) {
...
var $author$project$Demo$LogisticRegression$epochDecoder = A5(
		...
		return $elm$http$Http$post(
			{
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'session_id',
								$elm$json$Json$Encode$string(demoId)),
								_Utils_Tuple2(
								'epoch_num',
								$elm$json$Json$Encode$int(epochNumber)),
								_Utils_Tuple2(
								'learning_rate',
				...
				url: $author$project$Constants$serverRoot + 'api/model/iter'
			});
	});
...
var $author$project$Demo$LogisticRegression$initDemo = $elm$http$Http$post(
	{
		...
		url: $author$project$Constants$serverRoot + 'api/model/new'
	});
					...
					function () {
						if (result.$ === 'Err') {
							...
							return _Utils_update(
								model,
								{
									serverError: $elm$core$Maybe$Just('Can\'t log in to server.')
								});
						} else {
							return model;
						}
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{demoId: id}),
						A2($author$project$Demo$LogisticRegression$getEpoch, 1, id));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								serverError: $elm$core$Maybe$Just('Can\'t get demo from server.')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Run':
				var epochNumber = msg.a;
				return _Utils_Tuple2(
					model,
					A2($author$project$Demo$LogisticRegression$getEpoch, epochNumber, model.demoId));
			default:
				var result = msg.a;
				return _Utils_Tuple2(
					function () {
						if (result.$ === 'Ok') {
							...
							return _Utils_update(
								model,
								{
									serverError: $elm$core$Maybe$Just('Can\'t get next epoch from server.')
								});
						}
					}(),
					$elm$core$Platform$Cmd$none);
			...
			case 'TutorialMsg':
				...
				if (_v3.$ === 'Tutorial') {
					...
					return A2(
						$author$project$Main$stepTutorial,
						model,
						A2($author$project$Page$Tutorial$update, msg, tutorial));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'NotFoundMsg':
...
var $author$project$Page$Tutorial$firstContentName = A2(
	$elm$core$Maybe$withDefault,
	'',
	$elm$core$List$head($author$project$Constants$courseNames));
...
var $author$project$Page$Tutorial$getContentName = function (index) {
	var lastIndex = $elm$core$List$length($author$project$Constants$courseNames) - 1;
	return (_Utils_cmp(index, lastIndex) > 0) ? A2(
		$elm$core$Maybe$withDefault,
		$author$project$Page$Tutorial$firstContentName,
		A2($author$project$Page$Tutorial$nth, lastIndex, $author$project$Constants$courseNames)) : A2(
		$elm$core$Maybe$withDefault,
		$author$project$Page$Tutorial$firstContentName,
		A2($author$project$Page$Tutorial$nth, index, $author$project$Constants$courseNames));
};
...
var $author$project$Style$color = {
...
var $author$project$Page$About$viewGithubCard = F2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$attribute, 'data-user', attributeValue),
						A2($elm$html$Html$Attributes$attribute, attributeName, attributeValue),
...
var $author$project$Page$About$viewRepoGithubCard = function (repoName) {
	return A2($author$project$Page$About$viewGithubCard, 'data-repo', repoName);
};
var $author$project$Page$About$viewUserGithubCard = function (userName) {
	return A2($author$project$Page$About$viewGithubCard, 'data-user', userName);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('About AIwaffle')
								]))
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('AIwaffle is an AI Learning Platform completely made by high school students.\n'),
							$mdgriffith$elm_ui$Element$text('We aim at AI beginners and provide original courses, extensive materials, and periodic blogs on AI, OI, and more.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Style$font.subtitle,
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('We are committed to open sourcing our contents to benefit AI learners around the world.')
						])),
					$author$project$Page$About$viewRepoGithubCard('AIwaffle'),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Style$font.subtitle,
					$mdgriffith$elm_ui$Element$text('Collaborators')),
					A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$Page$About$viewUserGithubCard,
						_List_fromArray(
							['IDl0T', 'AlienKevin', 'jimmy-zx', 'wlt233', 'nichujie', 'xuyinjiesh', 'MistakableQwQ']))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Style$font.subtitle,
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('We share our ideas on AI, intersting AI projects, and coding competitions in our blog.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$newTabLink,
					$author$project$Style$font.link,
					{
						label: $mdgriffith$elm_ui$Element$text('Check out our blog here.'),
...
var $author$project$Page$Home$ClosePopUp = {$: 'ClosePopUp'};
...
var $author$project$Page$Home$viewClosePopUpButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$alignRight,
		...
		]),
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Page$Home$ClosePopUp)
	});
var $author$project$Page$Home$viewBasePopUp = function (elements) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$color.yellow),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Style$color.dark),
				$mdgriffith$elm_ui$Element$spacing(20),
				$mdgriffith$elm_ui$Element$padding(20),
				...
				{
					blur: 5,
					color: $author$project$Style$color.dark,
					offset: _Utils_Tuple2(3, 3),
					size: 5
				}),
				$mdgriffith$elm_ui$Element$inFront($author$project$Page$Home$viewClosePopUpButton)
			]),
		elements);
};
...
var $author$project$Page$Home$ChangedUserPassword = function (a) {
	return {$: 'ChangedUserPassword', a: a};
};
var $author$project$Page$Home$LogIn = {$: 'LogIn'};
	...
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'margin-top', '45vh')),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			A2(
				$mdgriffith$elm_ui$Element$paragraph,
			...
			label: A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color($author$project$Style$color.darkYellow)
							]))
					]),
				{
...
var $author$project$Page$Tutorial$viewTutorialMenu = function (model) {
	return model.showMenu ? A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
					...
					function (contentIndex, _v0) {
						...
						return A2(
							...
							_List_Nil,
							{
								label: A2(
									$mdgriffith$elm_ui$Element$el,
									_Utils_eq(contentIndex, model.contentIndex) ? _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Font$bold,
											$mdgriffith$elm_ui$Element$Font$color($author$project$Style$color.yellow)
										]) : _List_fromArray(
			...
			return {
				body: _List_fromArray(
					[
						...
						$author$project$Page$Tutorial$view(tutorial))
					]),
				title: $author$project$Page$Tutorial$getContentName(tutorial.contentIndex)
			};
		default:
			var about = _v0.a;
			return {
