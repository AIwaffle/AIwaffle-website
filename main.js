...
{
	if (region.aX.am === region.bb.am)
	{
		return 'on line ' + region.aX.am;
	}
	return 'on lines ' + region.aX.am + ' through ' + region.bb.am;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.c7, request.d4, true);
		} catch (e) {
...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && $elm$core$Maybe$isJust(options.ba))
		{
			lang = options.ba.a;
		}
...
var $author$project$Main$Node = F5(
	function (x, y, pos, activation, weights) {
		return {s: activation, an: pos, at: weights, K: x, L: y};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b8: false, cg: r.cg, cG: r.cG, bh: r.bh, c7: r.c7, dZ: r.dZ, bS: r.bS, d4: r.d4}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cg: $elm$http$Http$emptyBody, cG: r.cG, bh: _List_Nil, c7: 'GET', dZ: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing, d4: r.d4});
};
var $author$project$Main$getContent = function (contentName) {
	return $elm$http$Http$get(
		{
			cG: $elm$http$Http$expectString($author$project$Main$GotContent),
			d4: './contents/' + (contentName + '.md')
		});
};
...
var $author$project$Main$backwardOneStep = function (model) {
	...
	var nextNet = A4($author$project$Main$updateWeights, currentLayerIndex, currentIndex, model.n, model.ab);
	return (currentIndex <= 0) ? ((currentLayerIndex <= 1) ? _Utils_update(
		model,
		{
			u: 0,
			b: _Utils_Tuple2(0, 0),
			n: $author$project$Main$clearActivations(model.ab)
		}) : _Utils_update(
		model,
		{
...
var $author$project$Main$forwardOneStep = function (model) {
	...
	var currentIndex = model.b.b;
	var nextNet = A4($author$project$Main$updateActivations, currentLayerIndex, currentIndex, model.n, model.ab);
	return (_Utils_cmp(currentIndex, layerLength) > -1) ? ((_Utils_cmp(currentLayerIndex, numberOfLayers - 1) > -1) ? _Utils_update(
		model,
		{
			...
			ab: A5($author$project$Main$generateRandomNet, model.w, model.ak, model.au, 128, $author$project$Main$generateAllLayerValues).a
		}) : _Utils_update(
		model,
		{
...
var $mdgriffith$elm_ui$Internal$Style$classes = {b_: 'a', aG: 'atv', b0: 'ab', b1: 'cx', b2: 'cy', b3: 'acb', b4: 'accx', b5: 'accy', b6: 'acr', a2: 'al', a3: 'ar', b7: 'at', aH: 'ah', aI: 'av', ca: 's', ce: 'bh', cf: 'b', ch: 'w7', cj: 'bd', ck: 'bdt', av: 'bn', cl: 'bs', aw: 'cpe', cs: 'cp', ct: 'cpx', cu: 'cpy', B: 'c', ay: 'ctr', aA: 'cb', aB: 'ccx', D: 'ccy', ai: 'cl', aC: 'cr', cx: 'ct', cy: 'cptr', cz: 'ctxt', cJ: 'fcs', be: 'focus-within', cK: 'fs', cM: 'g', aL: 'hbh', aM: 'hc', bi: 'he', aN: 'hf', bj: 'hfp', cP: 'hv', cR: 'ic', cT: 'fr', cV: 'iml', cW: 'imlf', cX: 'imlp', cY: 'implw', cZ: 'it', c_: 'i', bq: 'lnk', aa: 'nb', bs: 'notxt', dc: 'ol', dd: 'or', T: 'oq', dh: 'oh', bx: 'pg', by: 'p', di: 'ppe', dm: 'ui', q: 'r', dp: 'sb', dq: 'sbx', dr: 'sby', ds: 'sbt', dv: 'e', dw: 'cap', dy: 'sev', dH: 'sk', aZ: 't', dL: 'tc', dM: 'w8', dN: 'w2', dO: 'w9', dP: 'tj', aF: 'tja', dQ: 'tl', dR: 'w3', dS: 'w5', dT: 'w4', dU: 'tr', dV: 'w6', dW: 'w1', dX: 'tun', bT: 'ts', V: 'clr', d2: 'u', a_: 'wc', bX: 'we', a$: 'wf', bY: 'wfp', a0: 'wrp'};
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.t)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dz.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dz.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.q) + ('-' + ($elm$core$String$fromInt(pos.cw) + ('-' + ($elm$core$String$fromInt(pos.au) + ('-' + $elm$core$String$fromInt(pos.ak)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cP, $mdgriffith$elm_ui$Internal$Style$classes.V)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ca) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ca) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ca) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ca) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ay) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ax: closing, i: _List_Nil, I: _List_Nil, z: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								i: A2(
									$elm$core$List$cons,
									{ax: '\n}', i: _List_Nil, I: props, z: '@supports (' + (prop + (':' + (value + (') {' + parent.z))))},
									rendered.i)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.z + ('{' + (renderValues(rule.I) + (rule.ax + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.q) + (' / ' + ($elm$core$String$fromInt(position.q + position.ak) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cw) + (' / ' + ($elm$core$String$fromInt(position.cw + position.au) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.q) + ('-' + ($elm$core$String$fromInt(position.cw) + ('-' + ($elm$core$String$fromInt(position.au) + ('-' + $elm$core$String$fromInt(position.ak)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.aZ + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.aZ)))))))))),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ca, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.ay, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.b6])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ca, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.ay, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.b4])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ca, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.ay, $mdgriffith$elm_ui$Internal$Style$classes.b5])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ca, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.ay, $mdgriffith$elm_ui$Internal$Style$classes.b3])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.ca + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aZ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aM)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.ca + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aZ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aN)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.b_]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
							...
							case 2:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.dd]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.dc]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dv, $mdgriffith$elm_ui$Internal$Style$classes.cT]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b1);
	}
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.D + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ds + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bs)))))),
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Element$pointer,
							A2(
...
var $author$project$Main$layerStepControl = $author$project$Main$controlButton(
	{
		aO: $mdgriffith$elm_ui$Element$text('Move 1 Layer'),
...
var $mdgriffith$elm_ui$Element$Input$slider = F2(
	function (attributes, input) {
		...
		return A3(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(input.aO) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : A2($mdgriffith$elm_ui$Element$spacingXY, spacingX, spacingY),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(input.aO),
								A2(
								$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $author$project$Main$stepControl = $author$project$Main$controlButton(
	{
		aO: $mdgriffith$elm_ui$Element$text('Move 1 Step'),
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cJ: $elm$core$Maybe$Nothing, cP: $elm$core$Maybe$Nothing, c9: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dm, $mdgriffith$elm_ui$Internal$Style$classes.ca, $mdgriffith$elm_ui$Internal$Style$classes.dv]))),
		...
		return A2(
			...
			settings,
			{
				...
				Z: $joakin$elm_canvas$Canvas$Internal$Canvas$DrawableText(
					{aQ: $elm$core$Maybe$Nothing, bB: point, aZ: str})
			});
	});
...
var $joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$fillText, txt.aZ, x, y, txt.aQ),
			A2(
				$elm$core$List$cons,
...
var $joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$strokeText, txt.aZ, x, y, txt.aQ),
			A2(
				$elm$core$List$cons,
	...
	function (x, y, t, cmds) {
		return A2(
			...
			function () {
				if (!t.$) {
					var image = t.a;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, 0, 0, image.au, image.ak, x, y, image.au, image.ak, image.c$);
				} else {
					var sprite = t.a;
					var image = t.b;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, sprite.K, sprite.L, sprite.au, sprite.ak, x, y, sprite.au, sprite.ak, image.c$);
				}
			}(),
			cmds);
	});
		...
		return A3(
			...
			F2(
				function (width, height) {
					return {ak: height, c$: target, au: width};
				}),
			A2(
				$elm$json$Json$Decode$at,
				_List_fromArray(
		...
		return A3(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$elm$html$Html$Attributes$width(options.au),
						attrs))),
			A2(
				$elm$core$List$cons,
...
var $author$project$Main$neuralNet = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(model.G * 0.10)
					]),
				_List_fromArray(
					[
						A2(
						$joakin$elm_canvas$Canvas$circle,
						_Utils_Tuple2(node.K, node.L),
						model.G)
					])),
				A3(
				...
				_List_fromArray(
					[
						...
						{
							bd: 'sans-serif',
							bO: $elm$core$Basics$round(model.G * 0.8)
						}),
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(node.K + width, node.L - (height / 2)),
									width,
									height)
								])),
							A3(
							...
							_Utils_Tuple2(node.K + ((width * 3) / 2), node.L),
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2(start.K, start.L),
						_List_fromArray(
							[
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(end.K, end.L))
							]))
					]));
		});
	var displayEdges = F2(
	...
	return A3(
		...
		_Utils_Tuple2(model.au, model.ak),
		_List_Nil,
		_Utils_ap(
			clearBackground,
			_Utils_ap(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{cU: $author$project$Main$init, dJ: $author$project$Main$subscriptions, d3: $author$project$Main$update, d6: $author$project$Main$view});
