...
var $author$project$Page$Tutorial$update = F2(
	function (msg, model) {
		if (msg.$ === 'GetContentFromName') {
			...
			var _v2 = A2($elm$core$Debug$log, 'demoMsg', demoMsg);
			var _v3 = A2($elm$core$Debug$log, 'newDemo', newDemo);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{demo: newDemo}),
...
var $author$project$Page$Home$viewCourseCard = function (title) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$image('/assets/waffle.png'),
